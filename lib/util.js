...
util.array = {
    //Merge multiple arrays, the default will be repeated, you can keep the duplicate content by setting the parameter isDuplicate=true
    ...
    //Calculate the number of valid elements of the array, such as [1,9,,9,2,,10,,,21], it will return 6
    getRealLength: ary => {
        let length = 0;
    ...
    //Clear the invalid elements of the array and return a new array, such as passing [1,9,,9,2,,10,,,21], it will return [1,9,9,2,10,21]
    clear: ary => {
        let newAry = [];
...
util.talk = {
    //The activity information of string type is parsed into structured data, which is convenient for subsequent operations
    str2Obj: talks => {
        let results = [];
        let lightnings = {
            title: '#MERGED#',
